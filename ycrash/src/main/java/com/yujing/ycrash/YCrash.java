        ...
        try {
            ...
            if (perm == PackageManager.PERMISSION_GRANTED) {
                ...
                if (telephonyManager != null) {
                    appInfo.imei = android.os.Build.VERSION.SDK_INT >= 26 ? telephonyManager.getImei() : telephonyManager.getDeviceId();
        ...
        for (Field field : fields) {
            try {
                ...
                if (obj instanceof String[])
                    ...
                    sb.append(field.getName()).append("=").append(obj.toString()).append("\n");
            } catch (Exception e) {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.e(TAG, "异常提交网络超时，url：" + url);
                } catch (Exception e) {
                    Log.e(TAG, "异常提时交发生异常，url：" + url, e);
                }
            }
        });
        thread.start();
